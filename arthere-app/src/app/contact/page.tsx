  ...
  return (
    <div>
        ...
        <form onSubmit={handleSubmit} className="p-5 flex flex-col gap-4">
          ...
          <div>
            <label className="block text-[0.72rem] font-semibold text-[#aaa] mb-1.5 uppercase tracking-widest">
              Anything else you'd like to share? <span className="normal-case font-normal text-[#ccc]">(optional)</span>
            </label>
            <textarea
              value={message}
          ...
          {status === 'error' && (
            <p className="text-[0.85rem] text-[#b91c1c]">Something went wrong — please try again or email us directly at hello@artishere.org</p>
          )}
      ...
      <p className="text-center text-[0.82rem] text-[#bbb]">
        <Link href="/" className="hover:text-[#555] transition-colors no-underline text-[#bbb]">← Back to Art Here</Link>
      </p>
    </div>
  );
}
