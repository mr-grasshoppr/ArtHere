...
import { addPlaceNote, deletePlaceNote } from "../actions";
...
export default function PlaceNotes({
  placeId,
  initialNotes,
}: {
  placeId: string;
  ...
  function handleAdd() {
    ...
    startTransition(async () => {
      const note = await addPlaceNote(placeId, trimmed);
    ...
    <div className="bg-white border border-[#e5e5e5] rounded-lg p-5">
      ...
      <div className="mb-6">
        <textarea
          ...
          placeholder="Add a note about communication with this organization…"
          rows={3}
      ...
      {notes.length === 0 && <p className="text-sm text-[#999]">No notes yet.</p>}
